...
const defaultData = [
    ...
    sections: {
      ...
      servicePanels: [
        ...
        },
        {
          ...
          items: "Logotype Typography & Colour, Visual Language, Illustrations & 3D, Art Direction, Brandbook & Guidelines, Motion Design, Brand Applications",
          bgColor: "#0B0215",
        },
        {
          title: "Website",
          ...
          items: "UX Design, Website Design, Responsive Design, Website Motion, Animations",
          bgColor: "#F4EDD9",
        },
        {
          title: "Product",
          ...
          items: "UX Design, User Testing, Prototyping, UI Design, App Design, Interaction Design",
          bgColor: "#020817",
        },
      ],
      works: {
  ...
  },
  {
    ...
    sections: {
      projects: [
        { title: "MEMRI", subtitle: "TRUTH IS COMPLEX. SPEAK ITS LANGUAGE.", client: "MEMRI", category: "Civic + Public + Political", imageUrl: "" },
        { title: "Optifino", subtitle: "Technology", client: "Optifino", category: "Technology", imageUrl: "" },
        { title: "The One Toronto", subtitle: "Real Estate", client: "The One Toronto", category: "Real Estate", imageUrl: "" },
        { title: "JPMorgan", subtitle: "INTERNATIONAL COUNCIL", client: "JPMorgan", category: "Financial Services", imageUrl: "" },
        { title: "Aaron Matthew SIDS Research Guild", subtitle: "Not-For-Profit", client: "Aaron Matthew", category: "Not-For-Profit", imageUrl: "" },
        { title: "Centerbridge Partners", subtitle: "Banking + Finance", client: "Centerbridge", category: "Banking + Finance", imageUrl: "" },
        { title: "Coinbase", subtitle: "Banking + Finance", client: "Coinbase", category: "Banking + Finance", imageUrl: "" },
        { title: "Hotel on Rivington", subtitle: "Hospitality", client: "Hotel on Rivington", category: "Hospitality", imageUrl: "" },
        { title: "Special Olympics", subtitle: "Not-For-Profit", client: "Special Olympics", category: "Not-For-Profit", imageUrl: "" },
        { title: "South Africa Tourism", subtitle: "Civic + Public + Political", client: "South Africa Tourism", category: "Civic + Public + Political", imageUrl: "" },
        { title: "Boracho Hard Seltzer", subtitle: "Consumer", client: "Boracho", category: "Consumer", imageUrl: "" },
        { title: "Eurotech", subtitle: "B2B", client: "Eurotech", category: "B2B", imageUrl: "" },
        { title: "Humankind Investments", subtitle: "Banking + Finance", client: "Humankind Investments", category: "Banking + Finance", imageUrl: "" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    sections: {
      ...
      brandingPanels: [
        { title: "Strategy", description: "We define the clarity and direction that everything else builds on.", items: "Research & Insights, Brand Architecture, Positioning, Messaging, Naming", bgColor: "#cba6f7" },
